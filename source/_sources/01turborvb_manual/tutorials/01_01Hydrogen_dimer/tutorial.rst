...
The file ``do.sh`` is example for DFT calculation in :math:`b = 0.5, 0.6, \ldots, 1.5` by using ``template/fort.10``.
...
If you want to do a linear fitting, i.e, :math:`E(a) = E(0) + k_{1} \cdots a^2`, put evsa.in
...
All procedure is the same as in :ref:`turborvbtutorial_0101_03`. You may get:
...
All procedure is the same as in :ref:`turborvbtutorial_0101_04`. You may get:
