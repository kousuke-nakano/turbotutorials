...
C\ :sub:`2` dimer
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Download C\ :sub:`2` dimer structure :download:`C2.xyz <./C2.xyz>`.
...
C atom
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Download C atom structure :download:`C2.xyz <./C.xyz>`.
...
.. code-block:: bash
    ...
    export TURBOPREP_RUN_COMMAND="mpirun -np XX prep-mpi.x"
    turbogenius prep -r
...
.. code-block:: bash
    ...
    export TURBOVMC_RUN_COMMAND="mpirun -np XX turborvb-mpi.x"
    export TURBOREADFORWARD_RUN_COMMAND="mpirun -np XX readforward-mpi.x"
...
.. code-block:: bash
    ...
    export TURBOPREP_RUN_COMMAND="mpirun -np XX turborvb-mpi.x"
    turbogenius prep -r
...
1. VMC
  ...
  .. code-block:: bash
      ...
      export TURBOVMC_RUN_COMAND="mpirun -np XX turborvb-mpi.x"
      turbogenius vmc -r
